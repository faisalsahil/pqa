...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='pwdfield "+ this.extra_classes +"' name='"+fldname+"' id='"+this.pwdfieldid+"' placeholder='Password'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='pwdfield "+ this.extra_classes +"' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' placeholder='Password' style='display: none;'>";
